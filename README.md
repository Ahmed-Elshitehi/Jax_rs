...
Once the runtime starts, you can access the project at [http://localhost:8080/Jax](http://localhost:8080/Jax).
...
```
./mvnw clean package
docker build -t Jax:v1 .
```

You can then run the Docker image by executing:

```
docker run -it --rm -p 8080:8080 Jax:v1
```
